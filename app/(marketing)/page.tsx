    ...
    <div className="shell">
      ...
      <section className="feature-row">
        <div className="feature-copy">
          ...
          <p>
            Your ring shows how much you have left, not just what you ate. Slot
            cards for breakfast, lunch, dinner, and snack expand inline so you
            see exactly what landed in each meal. Tap the plus to log more.
            Nothing hidden behind another screen.
          </p>
        </div>
      ...
      <section className="feature-row reverse">
        <div className="feature-copy">
          ...
          <p>
            Snap a plate for honest macro ranges. Scan a menu before you order.
            Barcode a packaged good via Open Food Facts. Or type it in with AI
            food search that knows shawarma, kabsa, and Al Baik meals without a
            USDA database in sight.
          </p>
        </div>
        <div className="feature-shot">
          <Image
      ...
      <section className="feature-row">
        <div className="feature-copy">
          ...
          <p>
            Weekly adherence, streak, weight trend, and a projection band that
            re-tunes your targets as the scale moves. Formula-driven, never
            guessed. Weekly weigh-ins keep the plan honest.
          </p>
        </div>
        <div className="feature-shot">
          <Image
      ...
      <section className="plan-band">
        <div className="plan-band-copy">
          ...
          <p>
            ...
            schedule matched to your equipment + days available. Habit rules
            for hard scenarios (Ramadan, travel, work dinners). A week-by-week
            roadmap with monthly reviews.
          </p>
          <ul className="plan-bullets">
            <li>
              <span className="mono">01</span> Personalized nutrition rationale
              + weekly adjustment rules
            </li>
            <li>
              <span className="mono">02</span> 7-day meal plan with swap ideas
              + grocery staples
            </li>
            <li>
              <span className="mono">03</span> N-day training split matched to
              your gym / home setup
            </li>
            <li>
      ...
      {/* ─── FEATURE: FOODS DRIVING CALORIES ──────────────────────────── */}
      <section className="feature-row reverse">
        <div className="feature-copy">
          ...
          <p>
            ...
            your kcal, protein, carbs, and fat. Nutrient adherence broken down
            row by row against your targets. See the patterns you didn&apos;t
            know you had.
          </p>
        </div>
        <div className="feature-shot">
      ...
      <section className="ritual-band">
        ...
        <div className="ritual-cards">
          ...
          <div className="ritual-card">
            ...
            <div className="ritual-sub">
              What went well, what to change, and the week ahead in your 90-day
              plan.
            </div>
          </div>
        </div>
      ...
      <section className="feature-row">
        <div className="feature-copy">
          ...
          <p>
            A month view of meals, workouts, and weigh-ins. Colored dots for
            what you logged each day. Tap into any day for the full drawer
            {"—"} what you ate, what you lifted, where the weight went.
          </p>
        </div>
        <div className="feature-shot">
          <Image
      ...
      <section className="final-cta">
        ...
        <p className="final-sub">
          SE7A launches soon on iOS. Get on the waitlist to be one of the first
          in when it opens.
        </p>
        <Waitlist />
      </section>
